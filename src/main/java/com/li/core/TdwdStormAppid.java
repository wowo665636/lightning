 ...
 */
public class TdwdStormAppid implements Serializable {
    ...
    public String getUniquenKey(){
        StringBuilder sb = new StringBuilder()
                ...
                .append("appdelaytrack").append(Constant.SP_FILED).append(this.getAppdelaytrack()).append(Constant.DIM_TUPLE)
                ...
                .append("ett").append(Constant.SP_FILED).append(this.getEtt())//.append(Constant.DIM_TUPLE)
