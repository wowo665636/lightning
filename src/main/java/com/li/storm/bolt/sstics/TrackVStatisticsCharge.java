 ...
 * av 计费
 */
public class TrackVStatisticsCharge implements Serializable {
    private static final long serialVersionUID = 3174680546618693171L;
    private  JedisCluster jedisCluster;
    private AbstractTrackLog trackLog;
    private static final int EXPIRE_TIME = 24*60*60;

    public TrackVStatisticsCharge(JedisCluster jedisCluster, AbstractTrackLog trackLog){
